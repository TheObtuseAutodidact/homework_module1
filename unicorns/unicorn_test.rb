...
class UnicornTest < Minitest::Test
  ...
  def test_it_knows_if_it_is_white
    ...
    assert unicorn.white?, "Bob should be white, but isn't"
  end
  ...
  def test_it_knows_it_is_not_white
    unicorn = Unicorn.new("Roxy", "green")
    refute unicorn.white?, "I guess Roxy thinks she's white when she's green"
  end
